...
public class NewFragment extends BasicFragment implements OnRefreshListener, OnLoadMoreListener {
...
//                        adapter.notifyDataSetChanged();
    ...
    private void dynamicNew() {
        AlertUtils.showProgress(false, getActivity());
        Http.http.createApi(AuthApi.class).dynamicNew(page)
